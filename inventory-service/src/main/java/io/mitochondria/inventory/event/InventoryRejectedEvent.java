...
public class InventoryRejectedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8719520388065531543L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"InventoryRejectedEvent\",\"namespace\":\"io.mitochondria.inventory.event\",\"fields\":[{\"name\":\"orderId\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"}]}");
   ...
   */
  public InventoryRejectedEvent(java.lang.CharSequence orderId, java.lang.CharSequence email) {
   ...
   */
  public static io.mitochondria.inventory.event.InventoryRejectedEvent.Builder newBuilder() {
    return new io.mitochondria.inventory.event.InventoryRejectedEvent.Builder();
  }
   ...
   * @return A new InventoryRejectedEvent RecordBuilder
   */
  public static io.mitochondria.inventory.event.InventoryRejectedEvent.Builder newBuilder(io.mitochondria.inventory.event.InventoryRejectedEvent.Builder other) {
    if (other == null) {
      return new io.mitochondria.inventory.event.InventoryRejectedEvent.Builder();
    } else {
      return new io.mitochondria.inventory.event.InventoryRejectedEvent.Builder(other);
    }
  }
   ...
   * @return A new InventoryRejectedEvent RecordBuilder
   */
  public static io.mitochondria.inventory.event.InventoryRejectedEvent.Builder newBuilder(io.mitochondria.inventory.event.InventoryRejectedEvent other) {
    if (other == null) {
      return new io.mitochondria.inventory.event.InventoryRejectedEvent.Builder();
    } else {
      return new io.mitochondria.inventory.event.InventoryRejectedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<InventoryRejectedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.mitochondria.inventory.event.InventoryRejectedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.mitochondria.inventory.event.InventoryRejectedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderId)) {
        this.orderId = data().deepCopy(fields()[0].schema(), other.orderId);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.mitochondria.inventory.event.InventoryRejectedEvent.Builder setOrderId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.mitochondria.inventory.event.InventoryRejectedEvent.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.mitochondria.inventory.event.InventoryRejectedEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.mitochondria.inventory.event.InventoryRejectedEvent.Builder clearEmail() {
      email = null;
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof InventoryRejectedEvent)) {
      return false;
    }
    InventoryRejectedEvent other = (InventoryRejectedEvent) o;
